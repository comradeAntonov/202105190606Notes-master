...
public class DateTimePickerDialog extends AlertDialog implements OnClickListener {
    ...
    private DateTimePicker mDateTimePicker;//DateTimePicker控件，控件一般用于让用户可以从日期列表中选择单个值。
    ...
    public void setOnDateTimeSetListener(OnDateTimeSetListener callBack) {//将时间日期滚动选择控件实例化
        mOnDateTimeSetListener = callBack;
    }

    private void updateTitle(long date) {//按照上下午显示时间
        int flag =
    ...
    public void onClick(DialogInterface arg0, int arg1) {//arg0是接收到点击事件的对话框,arg1是该对话框上的按钮
